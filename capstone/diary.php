    ...
    <div class="read_list_wrap">
      ...
      <tbody>
			<?php
				...
				$sql = 'SELECT * FROM diary_board ORDER BY board_date desc';
...
<tr>
            <td> <?php  echo $row['board_child_name']?></td>
             <td><a href="/capstone/diary_view.php?uid=<?php echo $row['board_child_uid']?>&date=<?php echo $row['board_date']?>">
            <?php echo $row['board_t_uid'];?></a></td>
...
<?php  
  ...
  <div class="readbtn">
        <a href="./diary_write.php" class="write">등록</a>
      </div>
</div>
